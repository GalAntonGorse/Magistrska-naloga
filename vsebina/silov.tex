...
sledi, da je $a \in \mathcal{C}_1$, potem $e$ rečemo \emph{Arhimedova enota}.
Če je $I_n \in M_n (\mathcal{S})$ enota za urejenost za vse $n \in \N$, potem je $e$ \emph{enota za matrično urejenost}.
V primeru, ko je $I_n $ Arhimedova za vsak $n \in \N$, je $e$ \emph{Arhimedova enota za matrično urejenost} za $\mathcal{S}$.
...
Dokažimo še, da je $1 \in \mathcal{S}$ Arhimedova enota za matrično urejenost.
Za poljubno sebiadjungirano matriko $A \in M_n (\mathcal{S})$ je $\| A\| \cdot I_n - A \geq 0$, torej je $1$ enota za matrično urejenost.
Dokazati moramo še, da je $1 \in \mathcal{S}$ Arhimedova enota.
...
\begin{dokaz}[Dokaz izreka \ref{izr:choi-effros}]
    ...
    tako da $s(A_0) \not\geq 0$.
    Po Hahn-Banachovem separacijskem izreku (\cite[Theorem IV.3.9, str. 111]{conway1990}) obstaja realen linearen funkcional
...
Od sedaj naprej bomo delali v kategoriji $\osys_1$, v kateri so izomorfizmi enotske povsem izometrične bijekcije med operatorskimi sistemomi.
